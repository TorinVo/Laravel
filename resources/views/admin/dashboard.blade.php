        ...
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <div class="thumbnail no-margin-bottom">
                    <img src="{{ url('public/admin/img/thumbnails/picjumbo.com_IMG_4566.jpg') }}" class="img-responsive">
                    <div class="caption">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="thumbnail no-margin-bottom">
                    <img src="{{ url('public/admin/img/thumbnails/picjumbo.com_IMG_3241.jpg') }}" class="img-responsive">
                    <div class="caption">
                        <h3 id="thumbnail-label">Thumbnail label<a class="anchorjs-link" href="#thumbnail-label"><span class="anchorjs-icon"></span></a></h3>
                        <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
        ...
        <div class="card card-success">
            ...
            <div class="card-body no-padding">
                <ul class="message-list">
                    <a href="#">
                        <li>
                            <img src="{{ url('public/admin/img/profile/profile-1.jpg') }}" class="profile-img pull-left">
